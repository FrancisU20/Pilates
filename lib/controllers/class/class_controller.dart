...
class ClassController {
  Future<StandardResponse<List<ClassModel>>> getClassList() async {
    try {
      ...
      StandardResponse<List<ClassModel>> userClassListResponse =
          StandardResponse<List<ClassModel>>.fromJson(
        serverJson,
  ...
  Future<StandardResponse<ClassModel>> getClass(String classId) async {
    try {
      final apiBase = await ApiBaseService.create(contentType: 'json');
      final response = await apiBase.get('/classes/$classId');
      final serverJson = json.decode(response.body);
      ...
      StandardResponse<ClassModel> userClassResponse =
          StandardResponse<ClassModel>.fromJson(
        serverJson,
        (data) => ClassModel.fromJson(data),
      );
